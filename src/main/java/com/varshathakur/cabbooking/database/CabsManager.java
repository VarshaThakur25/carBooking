...
import com.varshathakur.cabbooking.exceptions.CabAlreadyExistsException;
import com.varshathakur.cabbooking.exceptions.CabNotFoundException;
...
public class CabsManager {
  ...
  public void onboardDriver(@NonNull final Cab newCab) {
